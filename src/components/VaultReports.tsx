        ...
        <div id="sales-report-content" style={{ color: '#3e3f29' }}>
          ...
          <div style={{
            ...
            <h1 style={{
              ...
              <i className="fa-solid fa-file-invoice" style={{ marginRight: '10px' }}></i>LandM Store Sales Report
            </h1>
            <p style={{
              color: '#7d8d86',
              fontSize: '16px'
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  This report was automatically generated by the LandM Store POS System. 
